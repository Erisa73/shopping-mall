...
public class ShopFrame extends JFrame {
    ...
    public ShopFrame(ProductService productService,
        ...
        sortBox.addActionListener(e -> {
            ...
            switch (index) {
                case 0 -> sorted = productService.sortByName(true);
                case 1 -> sorted = productService.sortByName(false);
                case 2 -> sorted = productService.sortByPrice(true);
                case 3 -> sorted = productService.sortByPrice(false);
